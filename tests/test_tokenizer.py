...
from minbpe import BasicTokenizer, RegexTokenizer, GPT4Tokenizer, RegexTokenizerFast
...
@pytest.mark.parametrize("tokenizer_factory", [BasicTokenizer, RegexTokenizer, GPT4Tokenizer, RegexTokenizerFast])
...
@pytest.mark.parametrize("tokenizer_factory", [BasicTokenizer, RegexTokenizer, RegexTokenizerFast])
